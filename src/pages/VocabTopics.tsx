...
export default function VocabTopics() {
  const topics = [
    { title: "Business & Strategy", count: 120, mastered: 45, icon: "💼", color: "bg-blue-100 text-blue-800" },
    { title: "Science & Environment", count: 85, mastered: 12, icon: "🔬", color: "bg-green-100 text-green-800" },
    { title: "Society & Politics", count: 150, mastered: 80, icon: "🏛️", color: "bg-purple-100 text-purple-800" },
    { title: "Daily Life & Culture", count: 200, mastered: 190, icon: "🍱", color: "bg-orange-100 text-orange-800" },
    { title: "Abstract Concepts", count: 95, mastered: 30, icon: "💭", color: "bg-pink-100 text-pink-800" },
    { title: "Compound Verbs", count: 110, mastered: 10, icon: "🔄", color: "bg-teal-100 text-teal-800" },
    { title: "Grammar", count: 100, mastered: 40, icon: "📚", color: "bg-indigo-100 text-indigo-800", path: "/grammar" },
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="px-3 py-1 rounded-full bg-tertiary-container text-on-surface text-xs font-bold uppercase tracking-wider">JLPT N2</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-headline font-bold text-on-surface mb-4 tracking-tight">JLPT N2 Vocabulary & Grammar</h1>
          <p className="text-lg text-on-surface-variant max-w-2xl">
            Master the essential vocabulary and grammar required for the JLPT N2 exam. Grouped by topic for easier memorization and context building.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        <div className="bg-surface-container-lowest rounded-2xl p-5 border border-surface-variant shadow-sm">
          ...
          <div className="text-3xl font-headline font-bold text-on-surface">760</div>
        </div>
        <div className="bg-surface-container-lowest rounded-2xl p-5 border border-surface-variant shadow-sm">
          <div className="flex items-center gap-3 text-on-surface-variant mb-2">
          ...
          <div className="flex items-end gap-2">
            <div className="text-3xl font-headline font-bold text-primary">367</div>
            <div className="text-sm text-on-surface-variant mb-1">/ 760</div>
          </div>
        </div>
        <div className="bg-surface-container-lowest rounded-2xl p-5 border border-surface-variant shadow-sm">
          <div className="flex items-center gap-3 text-on-surface-variant mb-2">
          ...
          <div className="text-3xl font-headline font-bold text-on-surface">12<span className="text-lg text-on-surface-variant font-normal">h</span> 45<span className="text-lg text-on-surface-variant font-normal">m</span></div>
        </div>
        <div className="bg-primary-container/20 rounded-2xl p-5 border border-primary/20 shadow-sm">
          ...
          <div className="text-3xl font-headline font-bold text-on-surface mb-2">15<span className="text-lg text-on-surface-variant font-normal">/20</span></div>
