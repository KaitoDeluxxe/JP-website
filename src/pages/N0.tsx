...
export default function N0() {
  const topics = [
    { title: "Slang & Internet Culture", count: 150, mastered: 20, icon: "📱", color: "bg-blue-100 text-blue-800" },
    { title: "Regional Dialects", count: 130, mastered: 15, icon: "🗾", color: "bg-green-100 text-green-800" },
    { title: "Idioms & Proverbs", count: 140, mastered: 30, icon: "🗣️", color: "bg-purple-100 text-purple-800" },
    { title: "Pop Culture & Media", count: 120, mastered: 10, icon: "🎬", color: "bg-orange-100 text-orange-800" },
    { title: "Yojijukugo", count: 110, mastered: 5, icon: "🀄", color: "bg-pink-100 text-pink-800" },
    { title: "Native Nuances", count: 150, mastered: 20, icon: "✨", color: "bg-teal-100 text-teal-800" },
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="px-3 py-1 rounded-full bg-tertiary-container text-on-surface text-xs font-bold uppercase tracking-wider">N0 Real Japanese</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-headline font-bold text-on-surface mb-4 tracking-tight">N0 Real Japanese</h1>
          <p className="text-lg text-on-surface-variant max-w-2xl">
            Master authentic, native-level Japanese beyond the JLPT. Learn slang, dialects, idioms, and natural expressions used in real life.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        <div className="bg-surface-container-lowest rounded-2xl p-5 border border-surface-variant shadow-sm">
          ...
          <div className="text-3xl font-headline font-bold text-on-surface">920</div>
        </div>
        <div className="bg-surface-container-lowest rounded-2xl p-5 border border-surface-variant shadow-sm">
          <div className="flex items-center gap-3 text-on-surface-variant mb-2">
          ...
          <div className="flex items-end gap-2">
            <div className="text-3xl font-headline font-bold text-primary">130</div>
            <div className="text-sm text-on-surface-variant mb-1">/ 920</div>
          </div>
        </div>
        <div className="bg-surface-container-lowest rounded-2xl p-5 border border-surface-variant shadow-sm">
          <div className="flex items-center gap-3 text-on-surface-variant mb-2">
          ...
          <div className="text-3xl font-headline font-bold text-on-surface">18<span className="text-lg text-on-surface-variant font-normal">h</span> 45<span className="text-lg text-on-surface-variant font-normal">m</span></div>
        </div>
